...
export const ENDPOINTS = {
  ...
  MOVIE_IMAGES: '/v1/api/phim', // /v1/api/phim/{slug}/images
  MOVIE_PEOPLES: '/v1/api/phim', // /v1/api/phim/{slug}/peoples
  MOVIE_KEYWORDS: '/v1/api/phim', // /v1/api/phim/{slug}/keywords
